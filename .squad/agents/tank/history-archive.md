...
**Context:** C# .NET 10.0 Azure Function pipeline, BDD testing with Gherkin/SpecFlow, multi-environment CI/CD (dev/test/prod), 125-hour budget. Owner: Eric De Carufel.
