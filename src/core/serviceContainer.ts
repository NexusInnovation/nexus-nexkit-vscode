...
import { CronScheduleBuilderPanelService } from "../features/cron-schedule-builder/cronScheduleBuilderPanelService";
...
export interface ServiceContainer {
  ...
  cronScheduleBuilder: CronScheduleBuilderPanelService;
}
...
export async function initializeServices(context: vscode.ExtensionContext): Promise<ServiceContainer> {
  ...
  const cronScheduleBuilder = new CronScheduleBuilderPanelService(context.extensionUri);
  ...
  context.subscriptions.push(cronScheduleBuilder);
