...
export class TelemetryService {
	...
	constructor(private context: vscode.ExtensionContext) {
		...
		this.extensionVersion = vscode.extensions.getExtension('nexusinno.nexkit-vscode')?.packageJSON.version || 'unknown';
	...
	private getConnectionString(): string | undefined {
		...
		const configConnectionString = vscode.workspace.getConfiguration('nexkit').get<string>('telemetry.connectionString');
