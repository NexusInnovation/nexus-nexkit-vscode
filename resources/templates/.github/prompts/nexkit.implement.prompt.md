...
- **Respect the instructions**: Read all relevant instructions files .github/copilot-instructions.md and matching .github/instructions/\*.md before starting implementation
